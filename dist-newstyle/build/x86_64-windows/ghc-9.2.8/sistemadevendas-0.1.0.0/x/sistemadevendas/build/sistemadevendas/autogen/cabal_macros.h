...
/* package sistemadevendas-0.1.0.0 */
#ifndef VERSION_sistemadevendas
#define VERSION_sistemadevendas "0.1.0.0"
#endif /* VERSION_sistemadevendas */
#ifndef MIN_VERSION_sistemadevendas
#define MIN_VERSION_sistemadevendas(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_sistemadevendas */
